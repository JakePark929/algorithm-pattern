package com.jake.algorithm.baekjoon.lv08_math_1;
 ...
 * 작성일 : 2023.07.25
 */
class B2720_LaundryOwnerDongHyuk {
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        sb.append(change / 1000).append(" ").append((change % 1000) / 500).append(" ").append((change % 500) / 100).append(" ").append((change % 100) / 10);
