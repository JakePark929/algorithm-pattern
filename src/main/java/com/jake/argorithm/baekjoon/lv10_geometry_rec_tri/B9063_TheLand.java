 ...
 * 임씨는 땅을 되찾으려 했지만 문서가 없으니 생떼 쓰는 것과 다를 바 없었다. 이러다가 임씨는 길바닥에 나앉게 생겼다.
 * <p>
 ...
 * <p>
 * 임씨는 즉시 민사소송을 통해 자신의 땅을 찾고자 했고
 * 논리적인 근거를 들어 옥구슬이 나오는 지점이 원래 자신의 땅의 한 지점이었다는 것을 주장하여
 * 결국 담당판사를 설득하는 데에 성공하였다.
...
class B9063_TheLand {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            xs.add(Integer.valueOf(st.nextToken()));
            ys.add(Integer.valueOf(st.nextToken()));
        }
        ...
        if (n > 1) {
            System.out.println((xs.get(xs.size() - 1) - xs.get(0)) * (ys.get(ys.size() - 1) - ys.get(0)));
        } else {
