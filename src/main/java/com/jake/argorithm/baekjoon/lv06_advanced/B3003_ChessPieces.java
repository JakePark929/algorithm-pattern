 ...
 * 작성일 : 2023.07.21
 */
class B3003_ChessPieces {
    public static void main(String[] args) throws Exception {
        String[] noPieces = new String[]{String.valueOf(1 - read()), String.valueOf(1 - read()), String.valueOf(2 - read()), String.valueOf(2 - read()), String.valueOf(2- read()), String.valueOf(8- read())};
        System.out.println(String.join(" ", noPieces));
    }
