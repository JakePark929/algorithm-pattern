 ...
 * [List Interface]
 * <p>
 * ListInterface 는 ArrayList, SingleLinkedList, DoubleLinkedList 에 의해 각각 구현됩니다.
 *
...
public interface List<E> {
     ...
     * @return 리스트에서 중복을 허용하지 않을 경우에 리스트에 이미 중복되는 요소가 있을 경우 {@code false}
     * 중복되는 원소가 없을 경우 {@code true}를 반환
     */
    boolean add(E value);

    /**
     * 리스트의 특정 위치에 요소를 추가합니다.
     * 특정 위치 맟 이후 요소들은 한 칸 씩 뒤로 밀립니다.
     *
     * @param index 리스트에 요소를 추가할 특정 위치변수
     * @param value 리스트에 추가할 요소
     */
     ...
     * @return 리스트에 삭제할 요소가 없거나 삭제에 실패할 경우 {@code false}
     ...
     *
     * @return 리스트에 요소가 없을 경우 {@code true}
