 ...
 * 어떻게 공격을 한 건가? 솔라빔이란 공격에 대해서 공부를 한 건가?
 * <p>
 ...
 * 오영식 : 어? 오박사님 얘는 누구인가요?
 * <p>
 * 오박사 : 얘는 너의 라이벌이 될 친구 이다솜이라고 하네.
 * 자, 포켓몬을 한 마리 골라보도록 해봐라 다솜아. 레이디퍼스트 네가 먼저 골라봐라.
 * <p>
 ...
 * <p>
 * 경비원 : 사천왕과 대결을 하려면,
 * 마을의 체육관 리더를 이겨서 배지를 8개를 모아야 한다네... 배지를 모아서 오도록 하게
 * <p>
 ...
 * 그럼 땡큐~
 * <p>
 * 이게 오박사님이 나에게 새로 주시려고 하는 도감이야.
 * 너무 가지고 싶다ㅠㅜ. 꼭 만점을 받아줬으면 좋겠어!! 파이팅!!!
 * <p>
 * 작성일 : 2023.08.07
 */
class B1620_ImPokemonMasterLeeDaSom {
    public static void main(String[] args) throws IOException {
        ...
        HashMap<String, String> nameDex = new HashMap<>();

        for (int i = 0; i < n; i++) {
            String pokemon = br.readLine();
            pokedex.put(String.valueOf(i + 1), pokemon);
            nameDex.put(pokemon, String.valueOf(i + 1));
        }
        ...
        for (int i = 0; i < m; i++) {
            ...
            if (pokedex.containsKey(find)) {
                sb.append(pokedex.get(find));
            } else {
                sb.append(nameDex.get(find));
            }
            sb.append('\n');
        }
